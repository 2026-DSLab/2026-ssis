...
기존엔 테스트가 하나도 없었다. 실측 사고(2026-07-31, 대규모 워치리스트
...
def test_describe_formal_change_no_duplicated_josa_ga():
    """★★ 실측(2026-07-31, 국민기초생활보장법 제6조의2①): "통계청이"+
...
def test_describe_formal_change_strips_possessive_josa_too():
    ...
    소유격 '의'가 붙은 채로 뽑히면 "환경부장관의가"라는 비문이 나왔다."""
